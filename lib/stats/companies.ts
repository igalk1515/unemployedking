...
//
// Boards are COUNTS and DURATIONS, never percentages. "Oracle ghosted 43
// applications" is a fact about what this app tracked; "Oracle ghosts 100% of
// applicants" is a claim about the company that our sample cannot support. The
// speed board still needs a minimum number of rejections to average over.
...
/** Speed board needs this many actual rejections before an average means anything. */
...
export async function getCompanyLeaderboards(): Promise<CompanyLeaderboards> {
  ...
  for (const agg of aggs.values()) totalApplications += agg.applications;
